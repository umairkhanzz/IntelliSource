...
export const Table = () => {
  return (
    <section class="border-2 border-black w-full dark:bg-gray-900 p-3 sm:p-5">
      <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
        <div class="bg-white dark:bg-gray-800 relative shadow-md px-5 sm:rounded-lg overflow-hidden">
